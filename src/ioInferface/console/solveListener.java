...
public class solveListener extends AConsoleListener implements IConsoleListener {
	private String inputString = " ";

	private String[] possiblesSolvingAlgo;
	private mazeHandler _mytest;

	public solveListener(String[] inputString, mazeHandler test, Conf globalConf) {
		super(globalConf);
		_mytest = test;
